...
This is a version of Tetris that doesn't increase the level and always stays at the same speed in "Relax" mode. Play relaxing, not crazy.
...
請按 Clone or download，再按 Download ZIP，即可下載本遊戲。

解開下載的檔案，使用網頁瀏覽器開啟 Play.html，即可執行遊戲。
...
每家網頁瀏覽器設定的方案不一樣，以 Chromium 系列來講，在網址列輸入：

chrome://flags/#autoplay-policy

將 Autoplay policy 設為 No user gesture is required 即可。
